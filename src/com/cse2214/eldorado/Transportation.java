...
public class Transportation {
    ...
    void buspurchase() {
        ...
        if (choice == 1) {
            ...
            // Payment_Directory<<'\n'<<date<<' '<<Number<<' '<<Employee_ID<<' '<<Name<<'
            // '<<Phone_No<<' '<<sum<<" Visa_Card "<<card<<' '<<otp;
            ...
            // ofstream Payment_Directory("Payment_Directory.txt",ios::app);
            // Payment_Directory<<'\n'<<date<<' '<<Number<<' '<<Employee_ID<<' '<<Name<<'
            // '<<Phone_No<<' '<<sum<<" Master_Card "<<card<<' '<<otp;
            ...
            // ofstream Payment_Directory("Payment_Directory.txt",ios::app);
            // Payment_Directory<<'\n'<<date<<' '<<Number<<' '<<Employee_ID<<' '<<Name<<'
            // '<<Phone_No<<' '<<sum<<" American_Express_Card "<<card<<' '<<otp;
            // Payment_Directory.close();
