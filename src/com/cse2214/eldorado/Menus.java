...
public class Menus
{
    ...
    void userLoginSuccessfull()
    {
        ...
        System.out.println( ANSI_GREEN+ "\t\t\t\t\t\t|                User LOGIN Successfull              |"+ ANSI_RESET);
        System.out.println( ANSI_GREEN+ "\t\t\t\t\t\t|               Redirecting To User Menu             |"+ ANSI_RESET);
        System.out.println( ANSI_GREEN+ "\t\t\t\t\t\t******************************************************"+ ANSI_RESET);
    }
    ...
    void userLoginUnSuccessfull()
    {
        ...
        System.out.println(ANSI_RED +"\t\t\t\t\t\t|            Email & Password doesn'n Match          |"+ ANSI_RESET);
        System.out.println(ANSI_RED +"\t\t\t\t\t\t|       Press enter to Return to Prtevious Menu      |"+ ANSI_RESET);
        System.out.println(ANSI_RED +"\t\t\t\t\t\t******************************************************"+ ANSI_RESET);
    }

    void Emergency Number()
    {
